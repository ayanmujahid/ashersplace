...
<main>
  ...
  <section class="page-hero">
    ...
    <div class="container page-hero-inner">
      <p class="eyebrow eyebrow-light reveal">About Us</p>
      <h1 class="page-hero-title reveal">The Heart Behind Asher's Place</h1>
      <p class="page-hero-lede reveal">Who we are, our why, our mission, our vision, and the objectives guiding our first 20 units.</p>
    </div>
  </section>
    ...
    <div class="container about-grid">
      <div class="about-media reveal">
        <div class="arch-frame arch-frame--tall">
          <img src="assets/images/who-we-are.png" alt="Diverse community board members reviewing documents together" loading="lazy">
        </div>
      ...
      <div class="about-content">
        ...
        <div class="values-grid reveal">
          ...
          <div class="value-item">
            <span class="value-icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none"><path d="M12 3l7 3v6c0 4.97-3.13 8.99-7 9-3.87-.01-7-4.03-7-9V6l7-3z" stroke="currentColor" stroke-width="1.6"/></svg></span>
          ...
          <div class="value-item">
            <span class="value-icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none"><circle cx="12" cy="8" r="3" stroke="currentColor" stroke-width="1.6"/><path d="M5 20c0-3.87 3.13-6 7-6s7 2.13 7 6" stroke="currentColor" stroke-width="1.6"/></svg></span>
          ...
          <div class="value-item">
            <span class="value-icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none"><path d="M4 19h16M6 19V9l6-5 6 5v10" stroke="currentColor" stroke-width="1.6"/></svg></span>
